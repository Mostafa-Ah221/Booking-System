...
import SliderInterviewPages_Staff from './SliderInterviewPages_Staff';
import NavInterview_Staff from './NavInterview_Staff';

export default function InterviewLayut_Staff() {
    ...
    <main className="mx-auto bg-white relative">
      ...
      <div className="grid grid-cols-12">
        ...
        <div 
          ...
          `}
        >
          <SliderInterviewPages_Staff toggleSidebar={toggleSidebar} id={id} />
        </div>
