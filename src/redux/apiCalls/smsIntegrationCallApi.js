...
const BASE_URL = "https://booking-system-demo.efc-eg.com/api/sms/settings";
const GET_INTEGRATIONS_URL = "https://booking-system-demo.efc-eg.com/api/sms/integrations";
...
export function createOrUpdateSmsSettings(payload) {
  return async (dispatch) => {
    ...
    try {
      ...
      const response = await axios.post(`https://booking-system-demo.efc-eg.com/api/sms/settings/store`, payload, {
        headers: {
