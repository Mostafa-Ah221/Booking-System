...
const AddAppointment = ({ 
  ...
  // التعديل هنا للوصول إلى customers.clients
 ...
 const handleSubmit = async () => {
  ...
  try {
    ...
    // استدعاء createAppointment function - استخدام customer ID في URL
    ...
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full md:w-1/2 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {(selectedCustomer || selectedInterview || selectedDate || selectedTime) && (
        ...
        {/* Fixed Bottom Section - الزر ثابت في الأسفل */}
        <div className="border-t bg-white p-6">
          <button
            onClick={handleSubmit}
            disabled={!selectedDate || !selectedTime || !selectedInterview || !selectedCustomer || isProcessing}
            className={`w-full py-3 rounded-lg font-medium transition-colors flex items-center justify-center ${
              selectedDate && selectedTime && selectedInterview && selectedCustomer && !isProcessing
